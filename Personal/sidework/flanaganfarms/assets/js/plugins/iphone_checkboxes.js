...
$.fn[iphoneStyle] = function(options) {
  var checkboxes = this.filter('.ui-checkbox');
...
$[iphoneStyle].defaults = {
	...
	disabledClass:     'iphone--check-disabled',
	containerClass:    'iphone-check-container',
	labelOnClass:      'iphone-check-label-on',
	labelOffClass:     'iphone-check-label-off',
	handleClass:       'iphone-check-handle',
	handleCenterClass: 'iphone-check-handle-center',
	handleRightClass:  'iphone-check-handle-right',
