...
window.Modernizr = (function( window, document, undefined ) {
    ...
    injectElementWithStyles = function( rule, callback, nodes, testnames ) {
      ...
      var style, ret, node,
          ...
          //Greg 6/29/12 - body not being null was reaking havoc with the admin tpc widget page
          //since it's always (i think) null when script is included in head section then let's just pretend it's always null
          body = null, /*document.body,*/ 
