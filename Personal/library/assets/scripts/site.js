...
//--------------------------------------------------------------------------------------------------------
// Mercer UX/UI Library - Datepicker JS Functions
// DATE - July 3, 2013
// AUTHOR - Doug Fraize, Matthew Holmes
//--------------------------------------------------------------------------------------------------------
...
var mulDatepickerDefaults = {
	...
	buttonImage: "assets/images/core/icons/calendar.png", // button image next to input field to trigger datepicker
	buttonImageOnly: true, // button image is set only as an image and not an image on a button element
	...
	maxDate: "2m+2w", // Dates in the future are disabled and navigation to the future is disabled, default is null, refer to jQuery UI Datepicker API documentation for disabing dates in the future (http://api.jqueryui.com/datepicker/#option-maxDate)
	numberOfMonths: 2, // Show # of months in datepicker
	...
	beforeShow: function(input, inst) {
		...
		var appendDatepickerMessage = function () {
			jQuery("<div class='mul-datepicker-message'><label>" + datepickerMessageLabel + "</label></div>").appendTo(".ui-datepicker-row-break");
		};
...
var mulDatepickerRange = function(id, options) {
	var datepickerId = jQuery("#"+id);
	datepickerId.datepicker(jQuery.extend({},mulDatepickerDefaults,mulDatepickerRangeDefaults,options));
};
//--------------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------------
	...
	var mulDialogModalDefaults = {
		...
		draggable: false, // Control if dialog is draggable, default is true
		...
		position:'center', // Control the position of the dialog
		...
		close: function () { // Events for when dialog closes
			jQuery(this).removeClass('js-mul-scroll-pane'); // Remove auto-scroll class
		}
	};
...
//--------------------------------------------------------------------------------------------------------
// Mercer UX/UI Library - Tooltip JS Functions
// DATE - July 3, 2013
// AUTHOR - Doug Fraize, Matthew Holmes
//--------------------------------------------------------------------------------------------------------
