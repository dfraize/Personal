<div class="masthead-adjust">
	<div class="col-24">
		<a class="logo masthead-demo-btn" href="javascript:;">
	...
	<nav role="navigation">
		<dl class="link-list-horz ui-masthead-nav">
			...
			<dd class="last-child ui-masthead-nav-more">
				<a #if($req.target=="reference" || $req.target=="libraries" || $req.target=="test_devices")class="current"#end href="/reference">Reference <span class="ui-masthead-nav-more-icn">&darr;</span></a>
				<dl class="link-list-horz ui-masthead-nav-more-menu">
					...
					<dd class="last-child">
						<a href="/test_devices">Test Devices</a>
					</dd>
				</dl>
			</dd>
		</dl>
...
<div id="js-ui-dialog-example" class="js-dialog ui-dialog-ctn">
	...
	<p>This is content for a jQuery UI dialog. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Curabitur pellentesque tortor sit amet quam euismod sollicitudin. Cras erat libero, blandit eu accumsan ac, tempus vitae enim. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec gravida venenatis velit vitae tincidunt. Nulla vitae turpis metus. Aliquam congue venenatis semper.</p>	
</div>