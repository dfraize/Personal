	...
	/**
 	...
 	p.init = function(){
		...
		/*=== MOBILE INITS ======================================================================*/
			...
			jQuery(".js-mb-navbar select").change(function() {
		...
		/*=== UI EXAMPLES ======================================================================*/
			...
			// JQUERY UI DIALOG
		 	jQuery('.js-ui-dialog-example-btn').click(function(){
				notify.idDialog('js-ui-dialog-example',{draggable:false,resizable:false,closeOnEscape:true,
					open: function(event, ui) {
						jQuery('.ui-widget-overlay').click(function(){
							jQuery('.js-dialog').dialog('destroy');
						});
	        			jQuery('.ui-dialog-titlebar-close').addClass('ui-btn xxx-small');
	    			}
    			});
			});
		...
		/*=== SITE JS ==========================================================================*/
			...
			jQuery('.masthead-demo-btn').click(function(){
				jQuery('.js-masthead-demo').toggle();
				jQuery('.js-masthead').toggle();
			});
